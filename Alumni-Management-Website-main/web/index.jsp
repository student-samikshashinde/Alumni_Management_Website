    ...
    <body>
        ...
        <div class="container-fluid p-0 m-0">
            <div class="jumbotron primary-background banner-background text-white">
                <div class="container">
                  <h4 class="display-3">Welcome to the Alumni Management Portal</h4>
<p>Reconnect with fellow graduates, explore career opportunities, and share your success stories in our vibrant alumni community.</p>
